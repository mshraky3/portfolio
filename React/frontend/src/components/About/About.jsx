        ...
        <div className={`aboutSection ${isArabic ? 'arabic' : ''}`} id="aboutSection">
            <div className="aboutImageSection">
                <div className="aboutCurcle">
                    <img src={img} alt={isArabic ? "صورة الملف الشخصي" : "Profile"} />
                </div>
            </div>
            <div className="aboutText">
                ...
                <div className="aboutTexticons">
                    <a href="https://www.instagram.com/m_alshraky/" target="_blank" rel="noopener noreferrer">
                        <img width="40" height="40" src="https://img.icons8.com/material-two-tone/100/instagram-new.png" alt={isArabic ? "انستجرام" : "instagram"} />
                    </a>
                    <a href="https://github.com/mshraky3" target="_blank" rel="noopener noreferrer">
                        <img width="40" height="40" src="https://img.icons8.com/fluency/40/github.png" alt={isArabic ? "جيت هاب" : "github"} />
                    </a>
                    <a href="https://wa.link/5zcep6" target="_blank" rel="noopener noreferrer">
                        <img width="40" height="40" src="https://img.icons8.com/ios-glyphs/40/whatsapp.png" alt={isArabic ? "واتساب" : "whatsapp"} />
                    </a>
                </div>
            </div>
        </div>
